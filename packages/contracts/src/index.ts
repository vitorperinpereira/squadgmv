...
export const executiveReportSchema = z.object({
  ...
  metricLinks: z.object({
    missions: z.array(
      z.object({
        ...
        planningItemId: z.string().nullable().optional(),
        planningItemTitle: z.string().nullable().optional(),
        kind: planningKindSchema.nullable().optional(),
        sector: sectorSchema.nullable().optional(),
        processType: processTypeSchema.nullable().optional(),
    ...
    handoffsPending: z.array(
      z.object({
        entityType: z.literal("handoff"),
        id: z.string(),
        title: z.string(),
        missionId: z.string().nullable().optional(),
        missionTitle: z.string().nullable().optional(),
    ...
    validationsOpen: z.array(
      z.object({
        entityType: z.literal("validation"),
        id: z.string(),
        title: z.string(),
        missionId: z.string().nullable().optional(),
        missionTitle: z.string().nullable().optional(),
  ...
  bySector: z.record(
    ...
    z.object({
      ...
      links: z.array(
        z.object({
          entityType: z.literal("planning_item"),
          id: z.string(),
          title: z.string(),
          missionId: z.string().nullable().optional(),
          missionTitle: z.string().nullable().optional(),
...
export const executiveReportReferenceSchema = z.object({
  entityType: z.enum([
    "mission",
    "planning_item",
    "handoff",
...
export const executiveReportTriggerSchema = z.enum([
  "manual",
  "scheduled",
  "queue"
]);

export const executiveReportSnapshotSchema = z.object({
  id: z.string(),
  trigger: executiveReportTriggerSchema,
...
export type ExecutiveReportReference = z.infer<
  typeof executiveReportReferenceSchema
>;
export type ExecutiveReportSnapshot = z.infer<
  typeof executiveReportSnapshotSchema
>;
